...
export default ((opts?: FooterOptions) => {
  ...
  const Footer: QuartzComponent = ({ displayClass }: QuartzComponentProps) => {
    ...
    return (
      <footer
        class={displayClass ?? ""}
        style="text-align:left;margin-bottom:4rem;opacity:0.7;line-height:1.6;font-size:0.9rem"
      >
        <div style="margin-bottom:0.5rem">
          Created with Quartz v{version} © {year}
        </div>
        <div style="margin-bottom:0.5rem">Copyright © {year} 绒花计划Wiki</div>
        <div style="margin-bottom:0.5rem">
          本站内容除特别说明外，均在{" "}
          <a
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;gap:1rem">
          ...
          >
            <img
              ...
              alt="CC BY-NC-SA 4.0"
              style="display:block;border:none;height:31px;width:auto"
            />
          </a>
        </div>
      </footer>
